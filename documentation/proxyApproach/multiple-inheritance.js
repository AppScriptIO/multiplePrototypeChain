function inheritsMultipleObjects({ baseObject, superObjects }) {
  ...
  const proxyHandler = {
    ...
    get(target, key, receiver) {
      ...
      return parent ? 
        Reflect.get(parent, key, receiver) : 
        void 0; // because `undefined` is a global variable and not a reserved word in JS. void simply insures the return of undefined.
    },
